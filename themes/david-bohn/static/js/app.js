...
!function (e, n, t) {
  function r(e, n) {
    ...
    var e = n.body;return e || (e = a(x ? "svg" : "body"), e.fake = !0), e;
  }function m(e, t, r, o) {
    var s,
        i,
        l,
    ...
    function u() {
      ...
      var f = y(e, o);if (!r(f, "undefined")) return f;
      ...
      if (m = e[d], v = N.style[m], i(m, "-") && (m = l(m)), N.style[m] !== t) {
        if (s || r(o, "undefined")) return u(), "pfx" == n ? m : !0;try {
          N.style[m] = o;
        } catch (h) {}if (N.style[m] != v) return u(), "pfx" == n ? m : !0;
      }
    }return u(), !1;
  }function g(e, n, t, o, s) {
    var i = e.charAt(0).toUpperCase() + e.slice(1),
        a = (e + " " + P.join(i + " ") + i).split(" ");return r(n, "string") || r(n, "undefined") ? v(a, n, o, s) : (a = (e + " " + z.join(i + " ") + i).split(" "), f(a, n, t));
  }function h(e, n, r) {
    return g(e, t, t, n, r);
  }var C = [],
      S = [],
      ...
      b = "Moz O ms Webkit",
      P = w._config.usePrefixes ? b.split(" ") : [];w._cssomPrefixes = P;var z = w._config.usePrefixes ? b.toLowerCase().split(" ") : [];w._domPrefixes = z;var E = { elem: a("modernizr") };Modernizr._q.push(function () {
    delete E.elem;
  });var N = { style: E.elem.style };Modernizr._q.unshift(function () {
    delete N.style;
  }), w.testAllProps = g, w.testAllProps = h, Modernizr.addTest("cssanimations", h("animationName", "a", !0)), o(), s(C), delete w.addTest, delete w.addAsyncTest;for (var T = 0; T < Modernizr._q.length; T++) {
    Modernizr._q[T]();
